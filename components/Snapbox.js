...
function Snapbox({ children, id, setState, state }) {
  ...
  return (
    <div
      id={id}
      className="lg:h-fit h-full min-h-full w-full shrink-0 snap-start snap-mandatory snap-always lg:flex lg:flex-col lg:justify-center pb-28 lg:pb-0 relative text-white "
    >
      {children}
