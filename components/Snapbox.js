...
function Snapbox({ children, id, setState, state }) {
  ...
  return (
    <div
      id={id}
      className="z-0 lg:h-screen lg:mt-0 lg:min-h-screen h-fit w-full shrink-0 snap-start snap-mandatory snap-always lg:flex lg:flex-col lg:justify-center lg:pb-0 relative text-white "
    >
      {children}
