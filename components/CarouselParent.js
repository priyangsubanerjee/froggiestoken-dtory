...
function CarouselParent({ children, state, setState }) {
  ...
  return (
    <div className="h-screen bg-transparent w-screen flex lg:block z-10 overflow-x-auto snap-x lg:snap-none snap-start snap-mandatory fixed inset-0 lg:pt-0 scrollContent">
      {children}
